...
typedef enum {
	...
	E_REG_RESETCORE        = E_CORE_SP_REG_BASE + 0x070c,
} e_core_reg_id_t;
...
typedef enum {
	...
	E_REG_LINKCFG       = E_CHIP_REG_BASE + 0x0300,
	E_REG_LINKTXCFG     = E_CHIP_REG_BASE + 0x0304,
	E_REG_LINKRXCFG     = E_CHIP_REG_BASE + 0x0308,
	E_REG_GPIOCFG       = E_CHIP_REG_BASE + 0x030c,
	E_REG_FLAGCFG       = E_CHIP_REG_BASE + 0x0318,
	E_REG_SYNC          = E_CHIP_REG_BASE + 0x031c,
	E_REG_HALT          = E_CHIP_REG_BASE + 0x0320,
	E_REG_RESET         = E_CHIP_REG_BASE + 0x0324,
	E_REG_LINKDEBUG     = E_CHIP_REG_BASE + 0x0328,
} e_chip_regs_t;
