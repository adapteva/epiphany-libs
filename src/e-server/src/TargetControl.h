...
protected:
  unsigned fAttachedCoreId;
    ...
    public:unsigned long GetAttachedCoreId ()
  {
...
public:
  ...
  { BYTE_, SHORT_, WORD_ };
  enum REQ_TYPE
  { READ_ = 0, WRITE_ = 1, KILL_ME = 2, TRACE_ME = 3, RESUME_ME = 4 };
  enum TRACE_REQ_TYPE
  { INIT_TRACE = 0, START_TRACE = 1, STOP_TRACE = 2 };
  ...
  {
    cerr <<
      "Warning: The Resume and Detach is only supported in the HW simulation target"
      << endl;
  }
